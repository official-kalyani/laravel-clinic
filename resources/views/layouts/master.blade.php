                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                ...
                                <!-- {{asset('images/front_images/img/loading.gif')}} -->
                                    <img src="{{asset('images/admin_login_images/logo-sm.svg') }}" alt="" height="28"> <span class="logo-txt">Dason</span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                ...
                                @csrf
                                    <div class="form-floating form-floating-custom mb-4">
                                        <input type="text" class="form-control" id="email" name="email" value="henry" placeholder="Enter User Name">
                                    ...
                                    <div class="form-floating form-floating-custom mb-4 auth-pass-inputgroup">
                                        <input type="password" class="form-control pe-5" id="password" name="password" value="" placeholder="Enter Password">
                                        <span class="text-danger"></span>
