                                ...
                                <div class="px-3" data-simplebar style="max-height: 386px;">
                                    <div class="d-flex align-items-center pb-4">
                                        <div class="avatar-md me-4">
                                            <img src="{{ asset('images/admin_login_images/avatar-2.jpg') }}" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center pb-4">
                                        <div class="avatar-md me-4">
                                            <img src="./assets/images/admin_login_images/avatar-4.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center pb-4">
                                        <div class="avatar-md me-4">
                                            <img src="./assets/images/admin_login_images/avatar-5.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center pb-4">
                                        <div class="avatar-md me-4">
                                            <img src="{{ asset('images/admin_login_images/avatar-6.jpg') }}" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center pb-4">
                                        <div class="avatar-md me-4">
                                            <img src="./assets/images/admin_login_images/avatar-8.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center pb-3">
                                        <div class="avatar-md me-4">
                                            <img src="./assets/images/admin_login_images/avatar-9.jpg" class="img-fluid rounded-circle" alt="">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <div class="px-3 chat-conversation" data-simplebar style="max-height: 350px;">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li>
                                            <div class="conversation-list">
                                                <div class="d-flex">
                                                    <img src="{{ asset('images/users/avatar-3.jpg') }} class="rounded-circle avatar-sm" alt="">
                                                    <div class="flex-1">
                                                        <div class="ctext-wrap">
                                                            <div class="ctext-wrap-content">
                                                                ...
                                                                <ul class="list-inline message-img mt-3  mb-0">
                                                                    <li class="list-inline-item message-img-list">
                                                                        <a class="d-inline-block m-1" href="">
                                                                            <img src="{{ asset('images/small/img-1.jpg') }} alt="" class="rounded img-thumbnail">
                                                                        </a>
                                                                    </li>

                                                                    <li class="list-inline-item message-img-list">
                                                                        <a class="d-inline-block m-1" href="">
                                                                            <img src="{{ asset('images/small/img-2.jpg') }} alt="" class="rounded img-thumbnail">
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
